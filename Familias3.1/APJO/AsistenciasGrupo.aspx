<%@ Page Language="C#" MasterPageFile="~/mast.Master" AutoEventWireup="true" CodeBehind="AsistenciasGrupo.aspx.cs" Inherits="Familias3._1.APJO.AsistenciasGrupo" %>
    ...
    <div>
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnAsignarSalidaTodos" runat="server" Text="Asignar Salida a Todos" CssClass="butonFormSec" Visible="false" OnClick="btnAsignarSalidaTodos_Click" />
                </td>
            </tr>
            <tr>
                <td>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <asp:Panel runat="server" ID="pnlReferencias" CssClass="formContTransModal" Visible="false">
        <table class="tblCenter">
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="btnCancelar" runat="server" Text="Cancelar" CssClass="butonFormSec" OnClick="btnCancelar_Click" />
                </td>
            </tr>
        </table>
                ...
                <td>
                    <asp:GridView ID="gdvReferencias" CssClass="tableCont" runat="server" AutoGenerateColumns="False">
                        <Columns>
                            ...
                            <asp:BoundField DataField="NotasRef" HeaderText="Notas" HtmlEncode="false" />
                            <asp:BoundField DataField="Edad" HeaderText="Edad" />
                            <asp:BoundField DataField="TipoMiembro" HeaderText="Tipo de Miembro" />
                            <%--                            <asp:BoundField DataField="Educacion" HeaderText="Info. Educativa" />--%>
                            <%-- <asp:TemplateField HeaderText="Semáforo">
