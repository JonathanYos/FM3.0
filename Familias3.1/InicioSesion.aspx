<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InicioSesion.aspx.cs" Inherits="Familias3._1.InicioSesion" %>
...
<head id="Head1" runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="Css/EstiloTabla.css" runat="server" />
                        ...
                        <td>
                            <table class="tblCenter">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="Cancelarbtn" CssClass="buttomSec" runat="server" Text="Iniciar Sesión / Log In" OnClick="Cancelarbtn_Click" Visible="false" Height="35px" />
                                    </td>
                                    <td>
                                        <asp:Button ID="Regresarbtn" CssClass="buttomRet" runat="server" Text="Regresar / Return" Visible = "false" OnClick="Regresarbtn_Click" Height="35px" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table class="tblCenter">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="btnCancelarCambio" CssClass="buttomSec" runat="server" Text="Iniciar Sesión / Log In" OnClick="btnCancelarCambio_Click" Visible="false" Height="35px" />
                                    </td>
                                    <td>
                                        <asp:Button ID="btnRegresarLogIn" CssClass="buttomRet" runat="server" Text="Regresar / Return" OnClick="btnRegresarLogIn_Click" Height="35px" />
                                    </td>
                                </tr>
                            </table>
                        </td>
